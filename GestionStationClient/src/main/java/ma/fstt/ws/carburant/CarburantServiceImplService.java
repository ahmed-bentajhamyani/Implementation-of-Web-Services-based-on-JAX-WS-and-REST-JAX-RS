 ...
 * 
 */
@WebServiceClient(name = "CarburantServiceImplService", targetNamespace = "http://carburant.ws.fstt.ma/", wsdlLocation = "http://localhost:7778/service/carburant?wsdl")
public class CarburantServiceImplService extends Service {
	...
	private final static QName CARBURANTSERVICEIMPLSERVICE_QNAME = new QName("http://carburant.ws.fstt.ma/",
			"CarburantServiceImplService");
	...
	/**
	 * 
	 * @return returns CarburantService
	 */
	@WebEndpoint(name = "CarburantServiceImplPort")
	public CarburantService getCarburantServiceImplPort() {
		return super.getPort(new QName("http://carburant.ws.fstt.ma/", "CarburantServiceImplPort"),
				CarburantService.class);
	}
	...
	public CarburantService getCarburantServiceImplPort(WebServiceFeature... features) {
		return super.getPort(new QName("http://carburant.ws.fstt.ma/", "CarburantServiceImplPort"),
				CarburantService.class, features);
	}
